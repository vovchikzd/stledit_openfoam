...
int main(int argc, char* argv[]) {
  std::string help =
      ...
      "\t-mv \t\tMove object. To specify the movement axis is typing '-mvx' or "
      "'-mvyz'.\n"
      ...
      "\t-tp \t\tCreate topoSetDict and refineMeshDict files in the system "
      "folder.\n"
  ...
  if (!is_edit && !is_convert && !parser.is_toposet && !parser.is_merge &&
      !parser.is_wave) {
